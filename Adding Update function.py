...
def Buttons():
    global Entry_Name, Entry_Number_Hired, Entry_Name
    Button_Append_Details = Button(main_window, text="Update", command=Update).grid(column=2, row=1, padx=10, sticky=W+E)
    Button_Print_Details = Button(main_window, text="Print Details").grid(column=2, row=2, padx=10, sticky=W+E)
    Button_Append_Details = Button(main_window, text="Quit program").grid(column=2, row=3, padx=10, sticky=W+E)
    Button_Append_Details = Button(main_window, text="Delete Reciept").grid(column=2, row=4, padx=10, sticky=W+E)
...
def Update():
    global Details, Entry_Name, Entry_Item_Hired, Entry_Number_Hired, Item
    Details.append([Entry_Name.get(), Item.get(), Entry_Number_Hired.get()])
